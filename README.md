...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `82.5µs` | `372.9µs` |
| [Day 2](./src/bin/02.rs) | `61.9µs` | `81.3µs` |
| [Day 3](./src/bin/03.rs) | `1.0ms` | `1.1ms` |
| [Day 6](./src/bin/06.rs) | `592.0ns` | `12.1ms` |
| [Day 8](./src/bin/08.rs) | `893.7µs` | `-` |
| [Day 9](./src/bin/09.rs) | `257.5µs` | `250.8µs` |
